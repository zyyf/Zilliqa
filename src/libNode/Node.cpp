                                    ...
                                    unsigned int offset, const Peer& from)
{
    ...
    // TODO: create valid txns for stress testing
    ...
    // toPubKey = m_mediator.m_selfKey.second;
    // vector<unsigned char> msgTo;
    // toPubKey.Serialize(msgTo, 0);
    ...
    {
        Transaction txn(version, nonce, fromAddr, fromPubKey, amount,
                        signature);
